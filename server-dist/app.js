...
export function createWarehouseApp(config) {
    ...
    app.post("/api/admin/packages/claim-next", requireSession, (req, res) => forward(req, res, "POST", "/admin/packages/claim-next", undefined, { supplier_code: safeQueryText(req.body?.supplier_code, 100) }));
